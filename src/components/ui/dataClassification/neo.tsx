  ...
  return (
    <>
      ...
      <div className="single">
        ...
        <div className="single">
          <h4>Diameter:</h4>
          <span>{objectData.diameter ? neoData?.objectData?.diameter +" KM" :"undefined"}</span>
        </div>
        ...
        <div className="single">
          ...
          <span><a href={'https://ssd.jpl.nasa.gov/tools/sbdb_lookup.html#/?sstr={'+objectData?.spkid+'}&view=VOPD'} target="_blank" rel="noopener noreferrer">{'https://ssd.jpl.nasa.gov/tools/sbdb_lookup.html#/?sstr={'+objectData?.spkid+'}&view=VOPD'}</a></span>
        </div>
